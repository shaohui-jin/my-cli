  ...
  render() {
    return (
      <>
        ...
        {/*</div>*/}
        {/*	<div class="layout-breadcrumb-setting-bar-flex mt14">*/}
        {/*		<div class="layout-breadcrumb-setting-bar-flex-label">{{ $t('message.layout.twoIsMenuBarColorHighlight') }}</div>*/}
        {/*		<div class="layout-breadcrumb-setting-bar-flex-value">*/}
